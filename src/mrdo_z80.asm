...
0066: ED 45       retn
0068: 3A 00 A0    ld   a,($A000)
006B: 47          ld   b,a
006C: 3A 01 A0    ld   a,($A001)
006F: A0          and  b
0070: E6 10       and  $10
...
00AB: FB          ei
00AC: 18 FE       jr   $00AC
00AE: 01 00 00    ld   bc,$0000
00B1: 29          add  hl,hl
00B2: 29          add  hl,hl
00B3: 29          add  hl,hl
00B4: 01 01 00    ld   bc,$0001
00B7: 00          nop
00B8: C5          push bc
00B9: D5          push de
00BA: E5          push hl
...
0154: 18 FE       jr   $0154
0156: 1A          ld   a,(de)
0157: E2 31 32    jp   po,$3231
015A: 2F          cpl
015B: E2 31 32    jp   po,$3231
015E: 44          ld   b,h
015F: E2 31 32    jp   po,$3231
0162: 59          ld   e,c
0163: E2 31 32    jp   po,$3231
0166: 6E          ld   l,(hl)
0167: E2 31 32    jp   po,$3231
016A: 83          add  a,e
016B: E2 31 32    jp   po,$3231
016E: 98          sbc  a,b
016F: E2 31 32    jp   po,$3231
0172: AD          xor  l
0173: E2 31 32    jp   po,$3231
0176: C2 E2 53    jp   nz,$53E2
0179: 43          ld   b,e
017A: D3 E2       out  ($E2),a
017C: 18 4B       jr   $01C9
017E: E2 E2 18    jp   po,$18E2
0181: 4B          ld   c,e
0182: F1          pop  af
0183: E2 18 4B    jp   po,$4B18
0186: 09          add  hl,bc
0187: E3          ex   (sp),hl
0188: 2B          dec  hl
0189: 54          ld   d,h
...
0193: E1          pop  hl
0194: DF          rst  $18
0195: 28 12       jr   z,$01A9
0197: E2 01 2F    jp   po,$2F01
019A: B6          or   (hl)
019B: E1          pop  hl
019C: 3C          inc  a
019D: 19          add  hl,de
...
01A2: A1          and  c
01A3: E1          pop  hl
01A4: 2A 0D CD    ld   hl,($CD0D)
01A7: DE 01       sbc  a,$01
01A9: 3A 01 A0    ld   a,($A001)
01AC: 17          rla
...
07D0: 00          nop
07D1: 0C          inc  c
07D2: 30 00       jr   nc,$07D4
07D4: 00          nop
07D5: 0E 90       ld   c,$90
07D7: C3 00 00    jp   $0000
07DA: 00          nop
07DB: C3 69 A0    jp   $A069
07DE: 00          nop
07DF: 00          nop
07E0: 0C          inc  c
07E1: 30 0A       jr   nc,$07ED
07E3: A0          and  b
07E4: 00          nop
07E5: 0C          inc  c
07E6: 53          ld   d,e
...
07FB: A0          and  b
07FC: 00          nop
07FD: C3 00 00    jp   $0000
0800: 0A          ld   a,(bc)
0801: A0          and  b
0802: 0C          inc  c
0803: 30 00       jr   nc,$0805
0805: 00          nop
0806: 0A          ld   a,(bc)
0807: 69          ld   l,c
0808: C3 00 00    jp   $0000
080B: 00          nop
080C: C3 06 B0    jp   $B006
080F: 00          nop
0810: 00          nop
0811: 0C          inc  c
0812: 30 00       jr   nc,$0814
0814: 65          ld   h,l
0815: DD          db   $dd
0816: DD          db   $dd
0817: 53          ld   d,e
...
0858: 00          nop
0859: 00          nop
085A: C3 00 00    jp   $0000
085D: 0A          ld   a,(bc)
085E: 00          nop
085F: 0C          inc  c
0860: 30 00       jr   nc,$0862
0862: 00          nop
0863: CF          rst  $08
0864: DD          db   $dd
0865: 53          ld   d,e
...
08A6: 00          nop
08A7: 00          nop
08A8: C3 06 90    jp   $9006
08AB: 00          nop
08AC: 00          nop
08AD: 0C          inc  c
08AE: 30 00       jr   nc,$08B0
08B0: 65          ld   h,l
08B1: DD          db   $dd
08B2: DD          db   $dd
08B3: 53          ld   d,e
...
08B9: 55          ld   d,l
08BA: 90          sub  b
08BB: C3 00 00    jp   $0000
08BE: 00          nop
08BF: 00          nop
08C0: 69          ld   l,c
08C1: 20 00       jr   nz,$08C3
08C3: 00          nop
08C4: 00          nop
08C5: 00          nop
08C6: 0A          ld   a,(bc)
...
08F4: 00          nop
08F5: 00          nop
08F6: C3 06 90    jp   $9006
08F9: 00          nop
08FA: 00          nop
08FB: 0C          inc  c
08FC: 30 00       jr   nc,$08FE
08FE: 65          ld   h,l
08FF: DD          db   $dd
0900: DD          db   $dd
0901: 53          ld   d,e
...
0955: 55          ld   d,l
0956: 90          sub  b
0957: C3 00 00    jp   $0000
095A: 00          nop
095B: 00          nop
095C: 69          ld   l,c
095D: 20 00       jr   nz,$095F
095F: 00          nop
0960: 00          nop
0961: 00          nop
0962: 0A          ld   a,(bc)
...
0978: B0          or   b
0979: 00          nop
097A: C3 C5 55    jp   $55C5
097D: 77          ld   (hl),a
097E: 75          ld   (hl),l
097F: 55          ld   d,l
0980: 30 A0       jr   nc,$0922
0982: 00          nop
0983: 00          nop
0984: 00          nop
0985: 00          nop
...
09BA: 00          nop
09BB: 00          nop
09BC: C3 E5 55    jp   $55E5
09BF: 5D          ld   e,l
09C0: 55          ld   d,l
09C1: 55          ld   d,l
09C2: 30 A0       jr   nc,$0964
09C4: 00          nop
09C5: 02          ld   (bc),a
09C6: 00          nop
09C7: 00          nop
...
0A5E: 00          nop
0A5F: 0C          inc  c
0A60: 30 02       jr   nc,$0A64
0A62: 00          nop
0A63: 06 90       ld   b,$90
0A65: C3 00 00    jp   $0000
0A68: 00          nop
0A69: 00          nop
0A6A: 69          ld   l,c
0A6B: A0          and  b
...
0A7A: 00          nop
0A7B: 00          nop
0A7C: C3 06 90    jp   $9006
0A7F: 00          nop
0A80: 00          nop
0A81: 0C          inc  c
0A82: 30 00       jr   nc,$0A84
0A84: 65          ld   h,l
0A85: DD          db   $dd
0A86: DD          db   $dd
0A87: 53          ld   d,e
...
0AC8: 00          nop
0AC9: 00          nop
0ACA: C3 06 90    jp   $9006
0ACD: 00          nop
0ACE: 00          nop
0ACF: 0C          inc  c
0AD0: 30 00       jr   nc,$0AD2
0AD2: 65          ld   h,l
0AD3: DD          db   $dd
0AD4: DD          db   $dd
0AD5: 53          ld   d,e
...
0B9F: 97          sub  a
0BA0: 00          nop
0BA1: C3 00 4D    jp   $4D00
0BA4: 82          add  a,d
0BA5: 11 83 C7    ld   de,$C783
0BA8: 80          add  a,b
0BA9: 15          dec  d
0BAA: 01 87 01    ld   bc,$0187
0BAD: 93          sub  e
0BAE: 02          ld   (bc),a
0BAF: C7          rst  $00
0BB0: 82          add  a,d
...
0BBE: 80          add  a,b
0BBF: 93          sub  e
0BC0: 01 45 82    ld   bc,$8245
0BC3: 0B          dec  bc
0BC4: 83          add  a,e
0BC5: C7          rst  $00
0BC6: 00          nop
0BC7: 11 81 D1    ld   de,$D181
0BCA: 81          add  a,c
0BCB: 05          dec  b
0BCC: 02          ld   (bc),a
0BCD: 91          sub  c
...
0CA9: 8C          adc  a,h
0CAA: 9B          sbc  a,e
0CAB: CD 3E 66    call $663E
0CAE: 7C          ld   a,h
0CAF: 89          adc  a,c
0CB0: AB          xor  e
0CB1: C8          ret  z
0CB2: 38 5D       jr   c,$0D11
0CB4: 66          ld   h,(hl)
0CB5: 8C          adc  a,h
0CB6: AC          xor  h
0CB7: CC 4D 57    call z,$574D
0CBA: 86          add  a,(hl)
0CBB: 8B          adc  a,e
0CBC: B8          cp   b
0CBD: CD 3C 58    call $583C
0CC0: 7D          ld   a,l
0CC1: 97          sub  a
0CC2: 9C          sbc  a,h
0CC3: A8          xor  b
...
0CC7: 8C          adc  a,h
0CC8: A8          xor  b
0CC9: CD 36 5C    call $5C36
0CCC: 5D          ld   e,l
0CCD: 8C          adc  a,h
0CCE: 95          sub  l
0CCF: CC 3B 56    call z,$563B
0CD2: 7D          ld   a,l
0CD3: AC          xor  h
0CD4: B5          or   l
0CD5: BB          cp   e
...
0EE0: 3A 00 A0    ld   a,($A000)
0EE3: CB 6F       bit  5,a
0EE5: CA 9C 0F    jp   z,$0F9C
0EE8: 18 0D       jr   $0EF7
0EEA: 3A 00 A0    ld   a,($A000)
0EED: CB 77       bit  6,a
...
1029: C9          ret
102A: 4A          ld   c,d
102B: 10 4A       djnz $1077
102D: 10 4A       djnz $1079
102F: 10 4A       djnz $107B
1031: 10 4A       djnz $107D
1033: 10 4A       djnz $107F
1035: 10 68       djnz $109F
1037: 10 77       djnz $10B0
1039: 10 68       djnz $10A3
103B: 10 77       djnz $10B4
103D: 10 68       djnz $10A7
103F: 10 59       djnz $109A
1041: 10 59       djnz $109C
1043: 10 59       djnz $109E
1045: 10 59       djnz $10A0
1047: 10 4A       djnz $1093
1049: 10 29       djnz $1074
104B: 29          add  hl,hl
104C: 0C          inc  c
104D: 18 12       jr   $1061
104F: 17          rla
...
15E3: 04          inc  b
15E4: 1D          dec  e
15E5: 11 AE 88    ld   de,$88AE
15E8: 26 03       ld   h,$03
15EA: 05          dec  b
15EB: 1D          dec  e
15EC: 11 AC 88    ld   de,$88AC
15EF: 26 03       ld   h,$03
15F1: 06 1D       ld   b,$1D
15F3: 11 AA 88    ld   de,$88AA
15F6: 26 03       ld   h,$03
15F8: 07          rlca
15F9: 1D          dec  e
15FA: 11 A8 88    ld   de,$88A8
15FD: 26 03       ld   h,$03
15FF: 08          ex   af,af'
1600: 1D          dec  e
1601: 11 A6 88    ld   de,$88A6
1604: 26 03       ld   h,$03
1606: 09          add  hl,bc
1607: 1D          dec  e
1608: 11 84 88    ld   de,$8884
160B: 26 04       ld   h,$04
160D: 01 00 1D    ld   bc,$1D00
1610: 11 CD 39    ld   de,$39CD
1613: 16 D5       ld   d,$D5
1615: D9          exx
1616: D1          pop  de
...
17FF: C9          ret
1800: 21 00 A0    ld   hl,$A000
1803: 3A 00 E0    ld   a,($E000)
1806: 1F          rra
1807: D0          ret  nc
1808: 21 01 A0    ld   hl,$A001
180B: C9          ret
...
2338: CB 7E       bit  7,(hl)
233A: C8          ret  z
233B: 3A 00 A0    ld   a,($A000)
233E: CB 46       bit  0,(hl)
2340: C8          ret  z
2341: 3A 01 A0    ld   a,($A001)
2344: C9          ret
...
31A0: C9          ret
31A1: C9          ret
31A2: 31 C9 31    ld   sp,$31C9
31A5: C9          ret
31A6: 31 C9 31    ld   sp,$31C9
31A9: C9          ret
31AA: 31 C9 31    ld   sp,$31C9
31AD: C9          ret
31AE: 31 C9 31    ld   sp,$31C9
31B1: C9          ret
31B2: 31 D9 31    ld   sp,$31D9
31B5: D9          exx
31B6: 31 D9 31    ld   sp,$31D9
31B9: D9          exx
31BA: 31 D9 31    ld   sp,$31D9
31BD: D9          exx
31BE: 31 D9 31    ld   sp,$31D9
31C1: D9          exx
31C2: 31 D9 31    ld   sp,$31D9
31C5: D9          exx
31C6: 31 E9 31    ld   sp,$31E9
31C9: C0          ret  nz
31CA: 00          nop
31CB: 0C          inc  c
31CC: 00          nop
...
3223: 03          inc  bc
3224: 03          inc  bc
3225: 10 15       djnz $323C
3227: 20 25       jr   nz,$324E
3229: 30 35       jr   nc,$3260
322B: 40          ld   b,b
322C: 45          ld   b,l
322D: 50          ld   d,b
322E: 60          ld   h,b
...
3A9A: 1C          inc  e
3A9B: 1E 1E       ld   e,$1E
3A9D: 20 20       jr   nz,$3ABF
3A9F: 22 22 24    ld   ($2422),hl
3AA2: 24          inc  h
3AA3: 26 26       ld   h,$26
3AA5: 28 28       jr   z,$3ACF
3AA7: 2A D5 00    ld   hl,($00D5)
3AAA: E2 00 EB    jp   po,$EB00
3AAD: 00          nop
3AAE: F3          di
3AAF: 00          nop
3AB0: FC 00 04    call m,$0400
3AB3: 01 09 01    ld   bc,$0109
3AB6: 0D          dec  c
3AB7: 01 11 01    ld   bc,$0111
3ABA: 13          inc  de
3ABB: 01 15 01    ld   bc,$0115
3ABE: 17          rla
3ABF: 01 1A 01    ld   bc,$011A
3AC2: 1C          inc  e
3AC3: 01 1E 01    ld   bc,$011E
3AC6: 20 01       jr   nz,$3AC9
3AC8: 22 01 24    ld   ($2401),hl
3ACB: 01 26 01    ld   bc,$0126
3ACE: 29          add  hl,hl
3ACF: 01 2B 01    ld   bc,$012B
3AD2: 33          inc  sp
3AD3: 01 00 01    ld   bc,$0100
3AD6: 0D          dec  c
3AD7: 01 15 01    ld   bc,$0115
3ADA: 1A          ld   a,(de)
3ADB: 01 1E 01    ld   bc,$011E
3ADE: 22 01 26    ld   ($2601),hl
3AE1: 01 2B 01    ld   bc,$012B
3AE4: 2F          cpl
3AE5: 01 31 01    ld   bc,$0131
3AE8: 33          inc  sp
3AE9: 01 35 01    ld   bc,$0135
3AEC: 37          scf
3AED: 01 3A 01    ld   bc,$013A
3AF0: 3C          inc  a
3AF1: 01 3E 01    ld   bc,$013E
3AF4: 40          ld   b,b
3AF5: 01 42 01    ld   bc,$0142
3AF8: 44          ld   b,h
3AF9: 01 49 01    ld   bc,$0149
3AFC: 4D          ld   c,l
3AFD: 01 55 01    ld   bc,$0155
3B00: 80          add  a,b
3B01: 00          nop
3B02: 89          adc  a,c
3B03: 00          nop
...
3B40: C0          ret  nz
3B41: 00          nop
3B42: C2 00 C4    jp   nz,$C400
3B45: 00          nop
3B46: C6 00       add  a,$00
3B48: C9          ret
3B49: 00          nop
3B4A: CB 00       rlc  b
3B4C: CD 00 CF    call $CF00
3B4F: 00          nop
3B50: D1          pop  de
3B51: 00          nop
3B52: D3 00       out  ($00),a
...
47B7: 02          ld   (bc),a
47B8: 2C          inc  l
47B9: 01 C0 03    ld   bc,$03C0
47BC: E0          ret  po
47BD: 01 F0 00    ld   bc,$00F0
47C0: F0          ret  p
47C1: 00          nop
...
49C4: 89          adc  a,c
49C5: 02          ld   (bc),a
49C6: 01 FD 89    ld   bc,$89FD
49C9: 02          ld   (bc),a
49CA: 02          ld   (bc),a
49CB: 3D          dec  a
49CC: 8A          adc  a,d
49CD: 02          ld   (bc),a
49CE: 01 5D 8A    ld   bc,$8A5D
49D1: 02          ld   (bc),a
49D2: 02          ld   (bc),a
...
4E58: 68          ld   l,b
4E59: 4F          ld   c,a
4E5A: 10 50       djnz $4EAC
4E5C: 3D          dec  a
4E5D: 50          ld   d,b
4E5E: 85          add  a,l
4E5F: 50          ld   d,b
4E60: FA 50 C9    jp   m,$C950
...
78DE: E6 78       and  $78
78E0: ED 78       in   a,(c)
78E2: F4 78 FD    call p,$FD78
78E5: 78          ld   a,b
78E6: 18 89       jr   $7871
78E8: 00          nop
78E9: 03          inc  bc
78EA: 22 18 1E    ld   ($1E18),hl
78ED: 98          sbc  a,b
78EE: 89          adc  a,c
78EF: 00          nop
78F0: 03          inc  bc
78F1: 20 12       jr   nz,$7905
78F3: 17          rla
78F4: 77          ld   (hl),a
78F5: 89          adc  a,c
78F6: 00          nop
